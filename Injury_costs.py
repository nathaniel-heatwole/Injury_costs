...
# https://github.com/nathaniel-heatwole/
# https://www.linkedin.com/in/nathaniel-heatwole/
...
# export figures (jpg, pdf)
fig_list = [fig1, fig2, fig3]
pdf = PdfPages('Injury_costs_plots.pdf')  # pdf output
for fig in fig_list:
    f = fig_list.index(fig) + 1
    fig.savefig('figure-' + str(f) + '.jpg', dpi=300)  # jpg output
    pdf.savefig(fig)
pdf.close()
del pdf, fig
